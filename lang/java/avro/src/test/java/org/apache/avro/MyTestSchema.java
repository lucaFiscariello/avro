...
public class MyTestSchema {
  ...
  public static class TestFile {
    ...
    public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] {
        {TypeElement.EMPTY,TypeEntry.BOOL },
        {TypeElement.VALID,TypeEntry.BOOL },
        {TypeElement.VALID,TypeEntry.INT },
        {TypeElement.VALID,TypeEntry.BYTE },
        {TypeElement.VALID,TypeEntry.LONG },
        {TypeElement.VALID,TypeEntry.FLOAT },
        {TypeElement.VALID,TypeEntry.RECORD },
        {TypeElement.VALID,TypeEntry.ENUM },
        {TypeElement.VALID,TypeEntry.ARRAY },
        {TypeElement.VALID,TypeEntry.MAP },
        {TypeElement.NULL,TypeEntry.BOOL},
        {TypeElement.NOVALID,TypeEntry.BOOL },
      });
    }

    public TestFile(TypeElement typeelement, TypeEntry typeentry) throws IOException, JSONException {
  ...
  public static class TestRecord {
    ...
    private void getOracle() {
        if(!nameRecord.equals(TypeElement.VALID) || !typeRecord.equals(TypeElement.VALID) || typefield.equals(TypeElementFiel.NO_VALID))
